...
urlpatterns = [
    ...
    path('post/',views.articles,name='post'),
    path('articles/<str:article_id>/', views.articles, name='articles_detail'),
    path('post/<int:article_id>/', views.post, name='post'),
    path('reading/', views.reading, name='reading'),
    path('reading/<int:article_id>/', views.reading, name='reading_detail'),
    path('teach/', views.teach, name='teach'),
    path('teach/<int:article_id>/', views.teach, name='teach_detail'),
